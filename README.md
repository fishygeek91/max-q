...
Pre-launch. Wave 1 is frozen (SHA-256 in `questions/HASHES.md`; first digest superseded before any model run). Questions unpublished until scoring. No model runs yet. Grok 4.7 not yet released; harness will be validated against Grok 4.6 as a stand-in.
